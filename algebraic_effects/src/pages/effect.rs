...
pub fn effect() -> Html {
    ...
    let effect: Vec<EffectInfo> = vec![
        ...
        EffectInfo{
            ...
            img: "./assets/koka-code-1.png".to_string(),
        }, 
         EffectInfo{
            ...
            img: "./assets/koka-code-2.png".to_string(),
        },
        EffectInfo{
            title:"Tail-Resumptive Operations".to_string(),
            content:vec![],
            img:"./assets/koka-code-3.png".to_string()
        },
        EffectInfo{
            title:"Value Operations".to_string(),
            content:vec![],
            img:"./assets/koka-code-4.png".to_string(),
        },
        EffectInfo{
        ...
        EffectInfo{
            ...
            img:"./assets/koka-code-8.png".to_string(),
        },EffectInfo{
            title:"".to_string(),
            content:vec![],
            img:"./assets/koka-code-9.png".to_string(),
        }
    ];
...
fn list_to_html(list: Vec<EffectInfo>) -> Vec<Html> {
    list.iter()
        .map(|item| {
            html! {
