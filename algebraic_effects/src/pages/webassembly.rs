...
pub fn webassembly() -> Html {
    ...
    html! {<div class={style_file}>
         ...
         <svg class="wa" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 302.69 157.03"
            onclick={click_webassembly}>
         <defs>
         </defs>
         <title style="color:white;">{"web-assembly"}</title>
