...
pub fn webassembly() -> Html {
    ...
    let open_article_1= Callback::from(move |_: _| {
    ...
    let open_article_2 = Callback::from(move |_: _| {
        let _url = "https://thenewstack.io/javascript-vs-wasm-which-is-more-energy-efficient-and-faster/";
        let _location = window().unwrap().location();
        _location.set_href(_url).unwrap();
    });
    html! {<div class={style_file}>
        ...
        <div class="link-pool">
         <button class="cssbuttons-io-button" style="width:138px;" onclick={open_article_1}> {"performance"}
        <div class="icon">
        <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h24v24H0z" fill="none"></path><path d="M16.172 11l-5.364-5.364 1.414-1.414L20 12l-7.778 7.778-1.414-1.414L16.172 13H4v-2z" fill="currentColor"></path></svg>
         </div>
        </button> 
        <button class="cssbuttons-io-button" style="width:108px;" onclick={open_article_2}> {"efficient"}
        <div class="icon">
        <svg height="24" width="24" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h24v24H0z" fill="none"></path><path d="M16.172 11l-5.364-5.364 1.414-1.414L20 12l-7.778 7.778-1.414-1.414L16.172 13H4v-2z" fill="currentColor"></path></svg>
         </div>
        </button>
